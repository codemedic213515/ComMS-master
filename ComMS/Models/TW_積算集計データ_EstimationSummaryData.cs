...
public partial class TW_積算集計データ_EstimationSummaryData
{
    ...
    public byte? 案_Scenario { get; set; }
    ...
    public float? 提出数量_QuotedQuantity { get; set; }
    ...
    public float? 歩掛_WorkHoursRate { get; set; }
